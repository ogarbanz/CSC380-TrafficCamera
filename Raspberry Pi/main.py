...
def settings():
    ...
    window.create_window(250, 340, anchor='n', window=note_label)
...
def help():
    ...
    how_it_works_text = "When a vehicle enters the frame, it should be detected\n" \
                        ...
                        "page, the measured speed, and pictures of the vehicle.\n" \
                        "For more information please visit the GitHub page by\n" \
                        "clicking \"GitHub\" below."
